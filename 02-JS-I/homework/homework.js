...
function multiplica(x, y) {
  ...
  // Tu código:
  var multiplicaRes= x * y;
  return multiplicaRes;
}
...
function esPositivo(numero) {
  ...
  if (numero > 0){
    PositivoNegativo= 'Es positivo';
  } else if (numero === 0){
    PositivoNegativo= false;
  } else{
    PositivoNegativo= 'Es negativo';
  }
